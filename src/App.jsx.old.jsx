    ...
    <>
      ...
      */}
        ...
        */}
          <div className="mt-6">
            <button
              className={`${color} ${rounded} ${border} ${textSize} px-6 py-3 text-white border-amber-400 font-medium transition focus:outline-none focus:ring-2 focus:ring-indigo-400`}
            >
              Tailwind Button
            </button>
          </div>
